      ...
      <div className="mx-auto max-w-4xl text-center">
        ...
        <div className="hero-item mt-8 flex justify-center gap-5 text-gray-400">
          <a href="https://github.com/" target="_blank">
            <GithubIcon className="transition hover:text-white" />
<LinkedinIcon className="transition hover:text-white" />
          </a>
          <a href="https://linkedin.com/" target="_blank">
            <Linkedin className="transition hover:text-white" />
          </a>
          <a href="mailto:your-email@gmail.com">
            <Mail className="transition hover:text-white" />
          </a>
        </div>
      </div>
    </section>
