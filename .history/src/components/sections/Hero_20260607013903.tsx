    ...
    >
      <div className="mx-auto grid min-h-[80vh] max-w-6xl items-center gap-14 md:grid-cols-2">
        ...
        <div className="hero-right flex flex-col items-center md:items-end">
          <div className="profile-card mb-8 h-72 w-72 overflow-hidden rounded-[2rem] border border-white bg-white p-3 shadow-2xl shadow-cyan-500/20 md:h-96 md:w-96">
            <img
              src="/profile.jpg"
          ...
          <h1 className="hero-text text-center text-5xl font-extrabold tracking-tight text-slate-950 md:text-right md:text-7xl">
            May Thet Naing Bo
          </h1>
