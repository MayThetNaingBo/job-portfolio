...
export default function Hero() {
  ...
  return (
    ...
    >
      < className="mx-auto grid min-h-[80vh] max-w-6xl items-center gap-14 md:grid-cols-2">
       ...
       < className="hero-right flex flex-col items-center">
  ...
  <h1 className="hero-text whitespace-nowrap text-center text-4xl font-extrabold tracking-tight text-slate-950 md:text-6xl">
    May Thet Naing Bo
  </h1>
