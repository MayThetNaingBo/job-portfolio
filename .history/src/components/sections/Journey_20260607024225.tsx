...
export default function EducationJourney() {
  ...
  <div className="edu-left-photo -ml-6 overflow-hidden rounded-[2.5rem] border-8 border-white bg-white shadow-2xl shadow-cyan-500/20 lg:-ml-20">
    <img
  ...
  <div className="edu-content px-2 text-center lg:px-8">
  ...
  <div className="edu-right-photo -mr-6 overflow-hidden rounded-[2.5rem] border-8 border-white bg-white shadow-2xl shadow-cyan-500/20 lg:-mr-20">
    <img
