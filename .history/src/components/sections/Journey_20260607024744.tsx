...
export default function EducationJourney() {
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-7xl">
        ...
        <div className="grid items-center gap-10 lg:grid-cols-[1fr_1.15fr_1fr]">
  <div className="edu-left-photo flex h-[520px] items-center justify-center overflow-hidden rounded-[2.5rem] border-8 border-white bg-white/80 p-3 shadow-2xl shadow-cyan-500/20">
    <img
  ...
  <div className="edu-content text-center">
    ...
    <p className="mt-6 text-lg leading-8 text-lg leading-8 text-slate-600">
      My education journey at Temasek Polytechnic strengthened my foundation in
      software development, web applications, databases, teamwork, and real-world
      project building.
    </p>

    <p className="mt-4 text-lg leading-8 text-lg leading-8 text-slate-600">
      Through coursework, internship experience, and portfolio projects, I
      developed practical skills in full-stack development, DevOps basics, and AI
      automation.
    </p>
  </div>

  <div className="edu-right-photo flex h-[520px] items-center justify-center overflow-hidden rounded-[2.5rem] border-8 border-white bg-white/80 p-3 shadow-2xl shadow-cyan-500/20">
    <img
