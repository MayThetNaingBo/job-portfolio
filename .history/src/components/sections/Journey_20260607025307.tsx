...
export default function EducationJourney() {
  ...
  practical software development tasks. This experience helped me connect my
  academic knowledge with real workplace expectations and strengthened my
  confidence in building useful technology solutions.
</p>
          </div>
        </div>
      </div>
