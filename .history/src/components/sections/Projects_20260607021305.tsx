...
const projects = [
  ...
  },
  {
    title: "WDiGi Store",
    description:
      "Production-level game top-up platform design with payment flow, supplier API, admin dashboard, queue, and refund handling.",
    tech: ["Next.js", "NestJS", "Prisma", "PostgreSQL", "Redis"],
  },
  {
    title: "CodeGuard AI",
    description:
      "Security scanning backend project with authentication, scan history, and AI-focused code review workflow.",
  ...
  },
  {
    title: "MayLingo",
    description:
      "Real-time speech translation mobile app concept with polite translation and emergency phrase mode.",
...
export default function Projects() {
  ...
  return (
    <section
      id="projects"
      ref={sectionRef}
      className="bg-gradient-to-br from-white via-sky-50 to-cyan-100 px-6 py-24 text-slate-900"
    >
      <div className="mx-auto max-w-6xl">
        <div className="mb-14 text-center">
          ...
          <p className="mx-auto mt-5 max-w-2xl text-lg leading-8 text-slate-600">
            A collection of full-stack, real-time, DevOps, AI, and production-minded projects.
          </p>
        </div>
        ...
        <div className="grid gap-6 md:grid-cols-2">
          {visibleProjects.map((project) => (
            <div
              key={project.title}
              className="project-card rounded-3xl border border-white/70 bg-white/75 p-7 shadow-xl shadow-cyan-500/10 backdrop-blur transition hover:-translate-y-2 hover:shadow-2xl hover:shadow-cyan-500/20"
            >
